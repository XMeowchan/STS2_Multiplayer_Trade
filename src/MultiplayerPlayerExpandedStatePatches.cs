...
internal static class MultiplayerPlayerExpandedStateReadyPatch
{
    ...
    private static Button CreateTradeButton(Player remotePlayer, string reason)
    {
        ...
        Button button = TradeUiSkin.CreateProceedButton(TradeUiText.TradeButton, new Vector2(150f, 46f));
...
internal static class MultiplayerPlayerExpandedStateTradeButtonLayout
{
    public static void LayoutTradeButton(Control tradeButton, Control backButton)
    {
        ...
        tradeButton.AnchorLeft = backButton.AnchorLeft;
        tradeButton.AnchorTop = backButton.AnchorTop;
        tradeButton.AnchorRight = backButton.AnchorRight;
        tradeButton.AnchorBottom = backButton.AnchorBottom;
        tradeButton.OffsetLeft = backButton.OffsetRight + gap;
        tradeButton.OffsetTop = backButton.OffsetTop;
        tradeButton.OffsetRight = tradeButton.OffsetLeft + width;
        tradeButton.OffsetBottom = tradeButton.OffsetTop + height;
    }
}
